                ...
                <form action="index.php?act=search" method="POST">
                    <div class="search_date">
                        <div class="checkIn">
                            ...
                            <div class="input"><input type="date" value="fsd" id="startdateId" class="form-control"
                                    required name="checkIn"></div>
                        </div>
                        <div class="checkOut">
                            <div class="label"><label for="inputEmail4">Ngày Kết Thúc</label><br></div>
                            <div class="input"><input type="date" value="fsd" id="enddateId" class="form-control"
                                    required name="checkOut"></div>
                        </div>
