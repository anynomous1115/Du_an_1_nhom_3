    ...
    <div class="container">
        ...
        <main>
            <div class="all">
                ...
                <form action="index.php?act=updatetk" class="forms" method="POST" name="frm" id="form-1">
                    <div class="formk">
                        <label for="">Full name</label> <br>
                        <input type="text" placeholder="John.snow" name="full_name" id="fullname" value="<?=$full_name?>">
                    ...
                    <div class="formk">
                        ...
                        <input type="text" name="CCCD_id" id="CCCD_id" value="<?=$CCCD_id?>">
                        <p class="form-message"></p>
                    </div>
                    <div class="formk">
                        <label for="">Ngày sinh</label> <br>
                        <input type="date" name="birth_date" id="birth_date" value="<?=$birth_date?>">
                        <p class="form-message"></p>
                    </div>
                    <div class="formk">
                        <label for="">Tên tài khoản</label> <br>
                        <input type="text"  name="user_name" id="username" value="<?=$user_name?>" >
                        <p class="form-message"></p>
                    </div>
                    <div class="formk">
                        <label for=" ">Mật khẩu</label> <br>
                        <input type="password" placeholder="********" name="password" id="password" value="<?=$password?>">
                        <p class="form-message"></p>
                    </div>
                    <div class="formk">
                    ...
                    <div class="formk">
                        ...
                        <input type="text" name="nationality" id="nationality" value="<?=$nationality?>">
                        <p class="form-message"></p>
                    </div>
